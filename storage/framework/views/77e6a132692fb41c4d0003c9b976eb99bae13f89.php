...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(URL::to('landing/css/slicknav.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(URL::to('landing/css/owl.theme.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(URL::to('landing/css/owl.carousel.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(URL::to('landing/css/owl.transitions.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(URL::to('landing/css/font-awesome.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(URL::to('landing/css/bootstrap.min.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(URL::to('landing/css/main.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(URL::to('landing/css/responsive.css')); ?>">
        <script src="<?php echo e(URL::to('landing/js/vendor/modernizr-2.6.2.min.js')); ?>"></script>
    ...
    <body>
							...
							<nav class="navbar navbar-default" role="navigation">
							  <div class="container-fluid">
								...
								<div class="navbar-header">
								  ...
								  <div class="nav-logo">
									<a href="#"><img src="<?php echo e(URL::to('landing/img/duein.png')); ?>" alt="logo"></a>
								  </div>
								</div>
								...
								<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
								  <ul class="nav navbar-nav">
									<li class="active">
                                      <?php if(Auth::check()): ?>
                                          <li><a class="ifSmall" href="<?php echo e(URL::route('nav.new')); ?>">New Task</a></li>
                                          <li><a class="ifSmall" href="<?php echo e(URL::route('user.profile', Auth::user()->username)); ?>">Profile</a></li>
                                          <li><a class="ifSmall" href="<?php echo e(URL::route('user.logout')); ?>">Logout</a></li>
                                      <?php else: ?>
                                          <li><a class="ifSmall" href="<?php echo e(URL::route('nav.signin')); ?>">Login</a></li>
                                          <li><a class="ifSmall" href="<?php echo e(URL::route('nav.signup')); ?>">Sign Up</a></li>
                                      <?php endif; ?>
								  </ul>
								</div><!-- /.navbar-collapse -->
							  </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-6">
                        <div class="block-right">
                            <div class="contact-area">
                                <ul>
                                    <?php if(Auth::check()): ?>
                                        <li><a href="<?php echo e(URL::route('nav.new')); ?>">New Task</a></li>
                                        <li><a href="<?php echo e(URL::route('user.profile', Auth::user()->username)); ?>">Profile</a></li>
                                        <li><a href="<?php echo e(URL::route('user.logout')); ?>">Logout</a></li>
                                    <?php else: ?>
                                        <li><a href="<?php echo e(URL::route('nav.signin')); ?>">Login</a></li>
                                        <li><a href="<?php echo e(URL::route('nav.signup')); ?>">Sign Up</a></li>
                                    <?php endif; ?>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="block-right">
                            <div class="block-right-img">
                                <img src="<?php echo e(URL::to('landing/img/main.png')); ?>" alt="img">
                            </div>
                        </div>
                    </div><!-- .col-md-6 close -->
                </div><!-- .row close -->
                            ...
                            <div class="gallery-list" id="owl-demo">
                                <div class="gallery-items item">
                                    <div class="gallery-img">
                                        <img src="<?php echo e(URL::to('landing/img/mobile-phon-2.png')); ?>" alt="img">
                                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="block-left">
                            <div class="contant-2-img">
                                <img src="<?php echo e(URL::to('landing/img/mobile-phon-3.png')); ?>" alt="img">
                            </div>
                        </div>
                    </div><!-- .col-md-6 close -->
                                ...
                                <div class="tm-contant">
									<div class="tm-contant-items" id="slide-testimonial">
										<div class="tm-contant-list item">
											<div class="tm-img">
												<img src="<?php echo e(URL::to('landing/img/pepole-img.png')); ?>" alt="img">
											</div>
											<div class="tm-text">
        ...
        <script>window.jQuery || document.write('<script src="<?php echo e(URL::to('landing/js/vendor/jquery-1.10.2.min.js')); ?>"><\/script>')</script>
        <script src="<?php echo e(URL::to('landing/js/owl.carousel.min.js')); ?>"></script>
        <script src="<?php echo e(URL::to('landing/js/bootstrap.min.js')); ?>"></script>
        <script src="<?php echo e(URL::to('landing/js/plugins.js')); ?>"></script>
        <script src="<?php echo e(URL::to('landing/js/main.js')); ?>"></script>
    </body>
</html>
