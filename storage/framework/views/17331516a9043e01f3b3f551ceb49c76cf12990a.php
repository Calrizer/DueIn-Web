...
<div class="container">
    <form id="contact" action="<?php echo e(route('task.create')); ?>" method="post">
        ...
        <fieldset>
            <select name="day" title="Day" class="day" id="day">
            ...
            <select name="month" title="Month" class="month" id="month">
            ...
            <select name="year" title="Year" class="year" id="year">
        ...
        <fieldset>
            <textarea placeholder="Description..." type="text" tabindex="2" name="description" required></textarea>
        </fieldset>
        <fieldset>
