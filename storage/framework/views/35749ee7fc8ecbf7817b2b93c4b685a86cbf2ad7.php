...
<div class="menuwrapper">
  <div class="menubar">
      <div class="menu-content">
          <img class="sublogo" src="<?php echo e(URL::to('task/icon.png')); ?>">
      </div>
      <div class="menu-content">
...
<div class="wrapper">
    <a href="<?php echo e(URL::route('nav.landing')); ?>"><img class="back" src="<?php echo e(URL::to('forms/arrow.png')); ?>" href="<?php echo e(URL::route('nav.landing')); ?>"/></a>
...
<div class="container">
  <form id="contact" action="<?php echo e(route('user.signup')); ?>" method="post">
    ...
    <fieldset>
      <input placeholder="Repeat your password..." type="password" tabindex="4" name="password-repeat" required>
    </fieldset>
    <p class="label">Username*</p>
    <fieldset>
      <input placeholder="Create a username..." type="text" tabindex="5" name="username" required>
    </fieldset>
    <p class="label">Country*</p>
    <fieldset>
      <select name="country" title="Country" class="country">
    ...
    <p class="label">Verify that you are human.*</p>
    <fieldset>
    ...
    <p class="agreement">By creating an account you agree to our <a href="<?php echo e(URL::route('nav.landing')); ?>" target="_blank" title="Terms and Privacy">Terms and Privacy</a>.</p>
